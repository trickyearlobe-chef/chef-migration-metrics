...
func (m *mockStore) CountNodePlatformDistributionDetailed(ctx context.Context, f datastore.NodeSnapshotFilter) ([]datastore.PlatformDistributionRow, int, error) {
	if m.CountNodePlatformDistributionDetailedFn != nil {
		return m.CountNodePlatformDistributionDetailedFn(ctx, f)
	}
	return nil, 0, nil
}
...
func (m *mockStore) CountNodesByDeploymentVersion(ctx context.Context, f datastore.NodeSnapshotFilter) ([]datastore.DeploymentVersionRow, int, error) {
	if m.CountNodesByDeploymentVersionFn != nil {
		return m.CountNodesByDeploymentVersionFn(ctx, f)
	}
	return nil, 0, nil
}
...
func (m *mockStore) GetRoleCompatSummary(ctx context.Context, f datastore.RoleFilter) (datastore.RoleFilterSummary, map[string]string, error) {
	if m.GetRoleCompatSummaryFn != nil {
...
func (m *mockStore) ListOwnerDuplicateDismissals(ctx context.Context) ([]datastore.OwnerDuplicateDismissal, error) {
	if m.ListOwnerDuplicateDismissalsFn != nil {
		return m.ListOwnerDuplicateDismissalsFn(ctx)
	}
	return nil, nil
}

func (m *mockStore) RestoreOwnerDuplicate(ctx context.Context, ownerA, ownerB string) error {
	if m.RestoreOwnerDuplicateFn != nil {
		return m.RestoreOwnerDuplicateFn(ctx, ownerA, ownerB)
	}
	return nil
}
...
func (m *mockStore) ListOffenceFingerprintsByTarget(ctx context.Context, targetChefVersion string) ([]datastore.CookstyleOffenceFingerprint, error) {
	if m.ListOffenceFingerprintsByTargetFn != nil {
		return m.ListOffenceFingerprintsByTargetFn(ctx, targetChefVersion)
	}
	return nil, nil
}
