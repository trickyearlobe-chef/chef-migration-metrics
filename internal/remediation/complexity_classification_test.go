...
// TestComputeCookstyleComplexity_CosmeticStyleWeightZero proves the safety
// property of the full ruleset: dropping --only floods the scan with the
// generic cosmetic tail (Style/, Layout/), but an unclassified Style cop at
// convention severity contributes 0 — widening the ruleset does not inflate
// complexity scores.
