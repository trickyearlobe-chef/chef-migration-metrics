...
func TestUpsertOrganisationParams_Defaults(t *testing.T) {
	...
	if p.ClientKeyCredentialName != "" {
		t.Errorf("zero-value ClientKeyCredentialName should be empty, got %q", p.ClientKeyCredentialName)
	}
}
...
func TestOrganisation_ZeroValue(t *testing.T) {
	...
	if o.ClientKeyCredentialName != "" {
		t.Errorf("zero-value ClientKeyCredentialName should be empty, got %q", o.ClientKeyCredentialName)
	}
}
