...
// The scan-behaviour settings, one tab of the CookStyle admin hub.
const INPUT_CLASS =
...
export function AdminCookstyleSettingsSection() {
    ...
    <div className="space-y-6">
      <div className="max-w-3xl">
        <p className="text-sm text-gray-500">
          How CookStyle runs: whether it scans at all, how long a scan may take,
          and any extra cops to load.
        </p>
      </div>
